#ifndef MYSQL_SEED_GENERATE_COLUMN_U_INTEGER_RANDOM_H_
#define MYSQL_SEED_GENERATE_COLUMN_U_INTEGER_RANDOM_H_
...
#endif /* ifndef MYSQL_SEED_GENERATE_COLUMN_U_INTEGER_RANDOM_H_ */
