#include "generate/column_u_integer.h"

#define BCUIF_MALLOC_FAILURE						\
MALLOC_FAILURE_MESSAGE("build_column_u_integer_fixed")

#define BCUIU_GROUP_MALLOC_FAILURE					\
MALLOC_FAILURE_MESSAGE("build_column_u_integer_unique_group")
